    ...
    return (
        <Modal onClose={props.onClose}>
            ...
            <div className={classes.actions}>
                ...
                {hasItems && <button disabled={!valid} className={!valid ? classes.button && ' ' && classes.disabled : classes.button}>Order</button>}
                {!valid && <p  className={classes.red}> You are reached the limit TUL (Tolerable Upper Limit: the maximum level of
